...
public class WheatCritterEntity extends TameableEntity implements GeoEntity {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    private static final TrackedData<Boolean> TRUSTING = DataTracker.registerData(WheatCritterEntity.class, TrackedDataHandlerRegistry.BOOLEAN);;
    ...
    static class TemptGoal extends net.minecraft.entity.ai.goal.TemptGoal {
        ...
        private final WheatCritterEntity critter;

        public TemptGoal(WheatCritterEntity critter, double speed, Predicate<ItemStack> foodPredicate, boolean canBeScared) {
