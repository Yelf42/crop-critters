...
public class DeadCoralShelfFeature extends Feature<DeadCoralShelfFeatureConfig> {

    public DeadCoralShelfFeature(Codec<DeadCoralShelfFeatureConfig> configCodec) {
        super(configCodec);
    }

    @Override
    public boolean generate(FeatureContext<DeadCoralShelfFeatureConfig> context) {
        ...
        DeadCoralShelfFeatureConfig config = context.getConfig();
